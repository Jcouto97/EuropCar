...
public class ExceptionMessages {
    ...
    public static final String USER_RENTING = "The user is already renting a vehicle";
    public static final String VEHICLE_RENTING = "The vehicle is already being rented";
}
